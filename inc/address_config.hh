#ifndef __ADDRESS_CONFIG_H__
#define __ADDRESS_CONFIG_H__
...
constexpr int kc_z_addr_depth_start         {kresult_offset_score_end};
...
constexpr int kconv2_DW_kernel_size            {3};
constexpr int kconv2_DW_kernel_depth           {1};
constexpr int kconv2_DW_kernel_num             {96};
constexpr int kconv2_DW_addr_interval_of_data  {32};
constexpr int kconv2_DW_addr_interval_of_prk   {52};
constexpr int kconv2_DW_bundle_num             {6};
constexpr int kconv2_DW_addr_info_range        {1};


constexpr int kconv2_PW_kernel_size            {1};
constexpr int kconv2_PW_kernel_depth           {96};
constexpr int kconv2_PW_kernel_num             {128};
constexpr int kconv2_PW_addr_interval_of_data  {32};
constexpr int kconv2_PW_addr_interval_of_prk   {1};
constexpr int kconv2_PW_bundle_num             {48};
constexpr int kconv2_PW_addr_info_range        {3};


constexpr int kconv3_DW_kernel_size            {3};
constexpr int kconv3_DW_kernel_depth           {1};
constexpr int kconv3_DW_kernel_num             {128};
constexpr int kconv3_DW_addr_interval_of_data  {32};
constexpr int kconv3_DW_addr_interval_of_prk   {52};
constexpr int kconv3_DW_bundle_num             {6};
constexpr int kconv3_DW_addr_info_range        {1};


constexpr int kconv3_PW_kernel_size            {1};
constexpr int kconv3_PW_kernel_depth           {128};
constexpr int kconv3_PW_kernel_num             {192};
constexpr int kconv3_PW_addr_interval_of_data  {32};
constexpr int kconv3_PW_addr_interval_of_prk   {1};
constexpr int kconv3_PW_bundle_num             {96};
constexpr int kconv3_PW_addr_info_range        {6};


constexpr int kconv4_DW_kernel_size            {1};
constexpr int kconv4_DW_kernel_depth           {192};
constexpr int kconv4_DW_kernel_num             {192};
constexpr int kconv4_DW_addr_interval_of_data  {32};
constexpr int kconv4_DW_addr_interval_of_prk   {52};
constexpr int kconv4_DW_bundle_num             {9};
constexpr int kconv4_DW_addr_info_range        {1};


constexpr int kconv4_PW_kernel_size            {1};
constexpr int kconv4_PW_kernel_depth           {192};
constexpr int kconv4_PW_kernel_num             {256};
constexpr int kconv4_PW_addr_interval_of_data  {32};
constexpr int kconv4_PW_addr_interval_of_prk   {1};
constexpr int kconv4_PW_bundle_num             {191};
constexpr int kconv4_PW_addr_info_range        {12};


constexpr int kconv5_DW_kernel_size            {3};
constexpr int kconv5_DW_kernel_depth           {1};
constexpr int kconv5_DW_kernel_num             {256};
constexpr int kconv5_DW_addr_interval_of_data  {32};
constexpr int kconv5_DW_addr_interval_of_prk   {52};
constexpr int kconv5_DW_bundle_num             {9};
constexpr int kconv5_DW_addr_info_range        {1};


constexpr int kconv5_PW_kernel_size            {1};
constexpr int kconv5_PW_kernel_depth           {1};
constexpr int kconv5_PW_kernel_num             {256};
constexpr int kconv5_PW_addr_interval_of_data  {32};
constexpr int kconv5_PW_addr_interval_of_prk   {1};
constexpr int kconv5_PW_bundle_num             {255};
constexpr int kconv5_PW_addr_info_range        {16};


constexpr int kconv6_DW_kernel_size            {3};
constexpr int kconv6_DW_kernel_depth           {1};
constexpr int kconv6_DW_kernel_num             {256};
constexpr int kconv6_DW_addr_interval_of_data  {32};
constexpr int kconv6_DW_addr_interval_of_prk   {52};
constexpr int kconv6_DW_bundle_num             {9};
constexpr int kconv6_DW_addr_info_range        {1};


constexpr int kconv6_PW_kernel_size            {1};
constexpr int kconv6_PW_kernel_depth           {1};
constexpr int kconv6_PW_kernel_num             {256};
constexpr int kconv6_PW_addr_interval_of_data  {32};
constexpr int kconv6_PW_addr_interval_of_prk   {1};
constexpr int kconv6_PW_bundle_num             {255};
constexpr int kconv6_PW_addr_info_range        {16};
...
constexpr int kc_z_k_bundle_num                {2259};
constexpr int kc_z_k_addr_info_range           {142};
...
constexpr int kr_z_k_bundle_num                {2238};
constexpr int kr_z_k_addr_info_range           {140};
...
constexpr int kc_x_bundle_num                   {2260};
constexpr int kc_x_addr_info_range              {142};
...
constexpr int kr_x_bundle_num                   {2241};
constexpr int kr_x_addr_info_range              {141};
...
constexpr int kcls_conv1_bundle_num             {2271};
constexpr int kcls_conv1_addr_info_range        {142};
...
constexpr int kcls_conv2_bundle_num             {2288};
constexpr int kcls_conv2_addr_info_range        {143};
...
constexpr int kcls_conv3_bundle_num             {2289};
constexpr int kcls_conv3_addr_info_range        {144};
...
constexpr int kbbox_conv1_bundle_num             {2214};
constexpr int kbbox_conv1_addr_info_range        {139};
...
constexpr int kbbox_conv2_bundle_num             {2265};
constexpr int kbbox_conv2_addr_info_range        {142};
...
constexpr int kbbox_conv3_bundle_num             {2280};
constexpr int kbbox_conv3_addr_info_range        {143};
...
constexpr int kcls_score_bundle_num                {1};
...
constexpr int kctr_score_bundle_num                {2};
...
constexpr int kconv1_addr_s_start           {kM_addr_end};
...
constexpr int kconv2_DW_addr_s_start           {kconv1_addr_end};
constexpr int kconv2_DW_addr_s_end             {kconv2_DW_addr_s_start+kconv2_DW_addr_info_range};
constexpr int kconv2_DW_addr_depth_start       {kconv2_DW_addr_s_end};
constexpr int kconv2_DW_addr_depth_end         {kconv2_DW_addr_depth_start+kconv2_DW_addr_info_range};
constexpr int kconv2_DW_addr_prkdepth_start    {kconv2_DW_addr_depth_end};
constexpr int kconv2_DW_addr_prkdepth_end      {kconv2_DW_addr_prkdepth_start+kconv2_DW_addr_info_range};
constexpr int kconv2_DW_addr_data_start        {kconv2_DW_addr_prkdepth_end};
constexpr int kconv2_DW_addr_data_end          {kconv2_DW_addr_data_start + kconv2_DW_bundle_num*kconv2_DW_addr_interval_of_data};
constexpr int kconv2_DW_addr_prk_start         {kconv2_DW_addr_data_end};
constexpr int kconv2_DW_addr_prk_end           {kconv2_DW_addr_prk_start + kconv2_DW_bundle_num*kconv2_DW_addr_interval_of_prk};
constexpr int kconv2_DW_addr_bias_start        {kconv2_DW_addr_prk_end};
constexpr int kconv2_DW_addr_bias_end          {kconv2_DW_addr_bias_start + kconv2_DW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv2_DW_addr_end               {kconv2_DW_addr_bias_end};



constexpr int kconv2_PW_addr_s_start           {kconv2_DW_addr_end};
constexpr int kconv2_PW_addr_s_end             {kconv2_PW_addr_s_start+kconv2_PW_addr_info_range};
constexpr int kconv2_PW_addr_depth_start       {kconv2_PW_addr_s_end};
constexpr int kconv2_PW_addr_depth_end         {kconv2_PW_addr_depth_start+kconv2_PW_addr_info_range};
constexpr int kconv2_PW_addr_prkdepth_start    {kconv2_PW_addr_depth_end};
constexpr int kconv2_PW_addr_prkdepth_end      {kconv2_PW_addr_prkdepth_start+kconv2_PW_addr_info_range};
constexpr int kconv2_PW_addr_data_start        {kconv2_PW_addr_prkdepth_end};
constexpr int kconv2_PW_addr_data_end          {kconv2_PW_addr_data_start + kconv2_PW_bundle_num*kconv2_PW_addr_interval_of_data};
constexpr int kconv2_PW_addr_prk_start         {kconv2_PW_addr_data_end};
constexpr int kconv2_PW_addr_prk_end           {kconv2_PW_addr_prk_start + kconv2_PW_bundle_num*kconv2_PW_addr_interval_of_prk};
constexpr int kconv2_PW_addr_bias_start        {kconv2_PW_addr_prk_end};
constexpr int kconv2_PW_addr_bias_end          {kconv2_PW_addr_bias_start + kconv2_PW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv2_PW_addr_end               {kconv2_PW_addr_bias_end};



constexpr int kconv3_DW_addr_s_start           {kconv2_PW_addr_end};
constexpr int kconv3_DW_addr_s_end             {kconv3_DW_addr_s_start+kconv3_DW_addr_info_range};
constexpr int kconv3_DW_addr_depth_start       {kconv3_DW_addr_s_end};
constexpr int kconv3_DW_addr_depth_end         {kconv3_DW_addr_depth_start+kconv3_DW_addr_info_range};
constexpr int kconv3_DW_addr_prkdepth_start    {kconv3_DW_addr_depth_end};
constexpr int kconv3_DW_addr_prkdepth_end      {kconv3_DW_addr_prkdepth_start+kconv3_DW_addr_info_range};
constexpr int kconv3_DW_addr_data_start        {kconv3_DW_addr_prkdepth_end};
constexpr int kconv3_DW_addr_data_end          {kconv3_DW_addr_data_start + kconv3_DW_bundle_num*kconv3_DW_addr_interval_of_data};
constexpr int kconv3_DW_addr_prk_start         {kconv3_DW_addr_data_end};
constexpr int kconv3_DW_addr_prk_end           {kconv3_DW_addr_prk_start + kconv3_DW_bundle_num*kconv3_DW_addr_interval_of_prk};
constexpr int kconv3_DW_addr_bias_start        {kconv3_DW_addr_prk_end};
constexpr int kconv3_DW_addr_bias_end          {kconv3_DW_addr_bias_start + kconv3_DW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv3_DW_addr_end               {kconv3_DW_addr_bias_end};



constexpr int kconv3_PW_addr_s_start           {kconv3_DW_addr_end};
constexpr int kconv3_PW_addr_s_end             {kconv3_PW_addr_s_start+kconv3_PW_addr_info_range};
constexpr int kconv3_PW_addr_depth_start       {kconv3_PW_addr_s_end};
constexpr int kconv3_PW_addr_depth_end         {kconv3_PW_addr_depth_start+kconv3_PW_addr_info_range};
constexpr int kconv3_PW_addr_prkdepth_start    {kconv3_PW_addr_depth_end};
constexpr int kconv3_PW_addr_prkdepth_end      {kconv3_PW_addr_prkdepth_start+kconv3_PW_addr_info_range};
constexpr int kconv3_PW_addr_data_start        {kconv3_PW_addr_prkdepth_end};
constexpr int kconv3_PW_addr_data_end          {kconv3_PW_addr_data_start + kconv3_PW_bundle_num*kconv3_PW_addr_interval_of_data};
constexpr int kconv3_PW_addr_prk_start         {kconv3_PW_addr_data_end};
constexpr int kconv3_PW_addr_prk_end           {kconv3_PW_addr_prk_start + kconv3_PW_bundle_num*kconv3_PW_addr_interval_of_prk};
constexpr int kconv3_PW_addr_bias_start        {kconv3_PW_addr_prk_end};
constexpr int kconv3_PW_addr_bias_end          {kconv3_PW_addr_bias_start + kconv3_PW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv3_PW_addr_end               {kconv3_PW_addr_bias_end};



constexpr int kconv4_DW_addr_s_start           {kconv3_PW_addr_end};
constexpr int kconv4_DW_addr_s_end             {kconv4_DW_addr_s_start+kconv4_DW_addr_info_range};
constexpr int kconv4_DW_addr_depth_start       {kconv4_DW_addr_s_end};
constexpr int kconv4_DW_addr_depth_end         {kconv4_DW_addr_depth_start+kconv4_DW_addr_info_range};
constexpr int kconv4_DW_addr_prkdepth_start    {kconv4_DW_addr_depth_end};
constexpr int kconv4_DW_addr_prkdepth_end      {kconv4_DW_addr_prkdepth_start+kconv4_DW_addr_info_range};
constexpr int kconv4_DW_addr_data_start        {kconv4_DW_addr_prkdepth_end};
constexpr int kconv4_DW_addr_data_end          {kconv4_DW_addr_data_start + kconv4_DW_bundle_num*kconv4_DW_addr_interval_of_data};
constexpr int kconv4_DW_addr_prk_start         {kconv4_DW_addr_data_end};
constexpr int kconv4_DW_addr_prk_end           {kconv4_DW_addr_prk_start + kconv4_DW_bundle_num*kconv4_DW_addr_interval_of_prk};
constexpr int kconv4_DW_addr_bias_start        {kconv4_DW_addr_prk_end};
constexpr int kconv4_DW_addr_bias_end          {kconv4_DW_addr_bias_start + kconv4_DW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv4_DW_addr_end               {kconv4_DW_addr_bias_end};



constexpr int kconv4_PW_addr_s_start           {kconv4_DW_addr_end};
constexpr int kconv4_PW_addr_s_end             {kconv4_PW_addr_s_start+kconv4_PW_addr_info_range};
constexpr int kconv4_PW_addr_depth_start       {kconv4_PW_addr_s_end};
constexpr int kconv4_PW_addr_depth_end         {kconv4_PW_addr_depth_start+kconv4_PW_addr_info_range};
constexpr int kconv4_PW_addr_prkdepth_start    {kconv4_PW_addr_depth_end};
constexpr int kconv4_PW_addr_prkdepth_end      {kconv4_PW_addr_prkdepth_start+kconv4_PW_addr_info_range};
constexpr int kconv4_PW_addr_data_start        {kconv4_PW_addr_prkdepth_end};
constexpr int kconv4_PW_addr_data_end          {kconv4_PW_addr_data_start + kconv4_PW_bundle_num*kconv4_PW_addr_interval_of_data};
constexpr int kconv4_PW_addr_prk_start         {kconv4_PW_addr_data_end};
constexpr int kconv4_PW_addr_prk_end           {kconv4_PW_addr_prk_start + kconv4_PW_bundle_num*kconv4_PW_addr_interval_of_prk};
constexpr int kconv4_PW_addr_bias_start        {kconv4_PW_addr_prk_end};
constexpr int kconv4_PW_addr_bias_end          {kconv4_PW_addr_bias_start + kconv4_PW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv4_PW_addr_end               {kconv4_PW_addr_bias_end};



constexpr int kconv5_DW_addr_s_start           {kconv4_PW_addr_end};
constexpr int kconv5_DW_addr_s_end             {kconv5_DW_addr_s_start+kconv5_DW_addr_info_range};
constexpr int kconv5_DW_addr_depth_start       {kconv5_DW_addr_s_end};
constexpr int kconv5_DW_addr_depth_end         {kconv5_DW_addr_depth_start+kconv5_DW_addr_info_range};
constexpr int kconv5_DW_addr_prkdepth_start    {kconv5_DW_addr_depth_end};
constexpr int kconv5_DW_addr_prkdepth_end      {kconv5_DW_addr_prkdepth_start+kconv5_DW_addr_info_range};
constexpr int kconv5_DW_addr_data_start        {kconv5_DW_addr_prkdepth_end};
constexpr int kconv5_DW_addr_data_end          {kconv5_DW_addr_data_start+kconv5_DW_bundle_num*kconv5_DW_addr_interval_of_data};
constexpr int kconv5_DW_addr_prk_start         {kconv5_DW_addr_data_end};
constexpr int kconv5_DW_addr_prk_end           {kconv5_DW_addr_prk_start + kconv5_DW_bundle_num*kconv5_DW_addr_interval_of_prk};
constexpr int kconv5_DW_addr_bias_start        {kconv5_DW_addr_prk_end};
constexpr int kconv5_DW_addr_bias_end          {kconv5_DW_addr_bias_start + kconv5_DW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv5_DW_addr_end               {kconv5_DW_addr_bias_end};



constexpr int kconv5_PW_addr_s_start           {kconv5_DW_addr_end};
constexpr int kconv5_PW_addr_s_end             {kconv5_PW_addr_s_start+kconv5_PW_addr_info_range};
constexpr int kconv5_PW_addr_depth_start       {kconv5_PW_addr_s_end};
constexpr int kconv5_PW_addr_depth_end         {kconv5_PW_addr_depth_start+kconv5_PW_addr_info_range};
constexpr int kconv5_PW_addr_prkdepth_start    {kconv5_PW_addr_depth_end};
constexpr int kconv5_PW_addr_prkdepth_end      {kconv5_PW_addr_prkdepth_start+kconv5_PW_addr_info_range};
constexpr int kconv5_PW_addr_data_start        {kconv5_PW_addr_prkdepth_end};
constexpr int kconv5_PW_addr_data_end          {kconv5_PW_addr_data_start+kconv5_PW_bundle_num*kconv5_PW_addr_interval_of_data};
constexpr int kconv5_PW_addr_prk_start         {kconv5_PW_addr_data_end};
constexpr int kconv5_PW_addr_prk_end           {kconv5_PW_addr_prk_start + kconv5_PW_bundle_num*kconv5_PW_addr_interval_of_prk};
constexpr int kconv5_PW_addr_bias_start        {kconv5_PW_addr_prk_end};
constexpr int kconv5_PW_addr_bias_end          {kconv5_PW_addr_bias_start + kconv5_PW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv5_PW_addr_end               {kconv5_PW_addr_bias_end};



constexpr int kconv6_DW_addr_s_start           {kconv5_PW_addr_end};
constexpr int kconv6_DW_addr_s_end             {kconv6_DW_addr_s_start+kconv6_DW_addr_info_range};
constexpr int kconv6_DW_addr_depth_start       {kconv6_DW_addr_s_end};
constexpr int kconv6_DW_addr_depth_end         {kconv6_DW_addr_depth_start+kconv6_DW_addr_info_range};
constexpr int kconv6_DW_addr_prkdepth_start    {kconv6_DW_addr_depth_end};
constexpr int kconv6_DW_addr_prkdepth_end      {kconv6_DW_addr_prkdepth_start+kconv6_DW_addr_info_range};
constexpr int kconv6_DW_addr_data_start        {kconv6_DW_addr_prkdepth_end};
constexpr int kconv6_DW_addr_data_end          {kconv6_DW_addr_data_start+kconv6_DW_bundle_num*kconv6_DW_addr_interval_of_data};
constexpr int kconv6_DW_addr_prk_start         {kconv6_DW_addr_data_end};
constexpr int kconv6_DW_addr_prk_end           {kconv6_DW_addr_prk_start + kconv6_DW_bundle_num*kconv6_DW_addr_interval_of_prk};
constexpr int kconv6_DW_addr_bias_start        {kconv6_DW_addr_prk_end};
constexpr int kconv6_DW_addr_bias_end          {kconv6_DW_addr_bias_start + kconv6_DW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv6_DW_addr_end               {kconv6_DW_addr_bias_end};



constexpr int kconv6_PW_addr_s_start           {kconv6_DW_addr_end};
constexpr int kconv6_PW_addr_s_end             {kconv6_PW_addr_s_start+kconv6_PW_addr_info_range};
constexpr int kconv6_PW_addr_depth_start       {kconv6_PW_addr_s_end};
constexpr int kconv6_PW_addr_depth_end         {kconv6_PW_addr_depth_start+kconv6_PW_addr_info_range};
constexpr int kconv6_PW_addr_prkdepth_start    {kconv6_PW_addr_depth_end};
constexpr int kconv6_PW_addr_prkdepth_end      {kconv6_PW_addr_prkdepth_start+kconv6_PW_addr_info_range};
constexpr int kconv6_PW_addr_data_start        {kconv6_PW_addr_prkdepth_end};
constexpr int kconv6_PW_addr_data_end          {kconv6_PW_addr_data_start+kconv6_PW_bundle_num*kconv6_PW_addr_interval_of_data};
constexpr int kconv6_PW_addr_prk_start         {kconv6_PW_addr_data_end};
constexpr int kconv6_PW_addr_prk_end           {kconv6_PW_addr_prk_start + kconv6_PW_bundle_num*kconv6_PW_addr_interval_of_prk};
constexpr int kconv6_PW_addr_bias_start        {kconv6_PW_addr_prk_end};
constexpr int kconv6_PW_addr_bias_end          {kconv6_PW_addr_bias_start + kconv6_PW_kernel_num/(kDramAccessBytes/2)};
constexpr int kconv6_PW_addr_end               {kconv6_PW_addr_bias_end};

/*=========  Weight: Feature Adjustment  ==========*/


constexpr int kc_z_k_addr_s_start           {kconv6_PW_addr_end};
...
constexpr int kcls_score_addr_bias_end          {kcls_score_addr_bias_start + kcls_score_kernel_num/(kDramAccessBytes/2)};
...
constexpr int kctr_score_addr_bias_end          {kctr_score_addr_bias_start + kctr_score_kernel_num/(kDramAccessBytes/2)};
...
constexpr int koffset_score_addr_bias_end          {koffset_score_addr_bias_start + koffset_score_kernel_num/(kDramAccessBytes/2)};
...
constexpr int koa_ft_map_addr_depth_end_3        {1+koa_ft_map_addr_depth_start+61*61/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_4        {1+koa_ft_map_addr_depth_start+30*30/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_5        {koa_ft_map_addr_depth_start+28*28/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_6        {koa_ft_map_addr_depth_start+28*28/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_7        {1+koa_ft_map_addr_depth_start+14*14/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_8        {1+koa_ft_map_addr_depth_start+12*12/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_9        {1+koa_ft_map_addr_depth_start+12*12/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_10       {1+koa_ft_map_addr_depth_start+10*10/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_11       {1+koa_ft_map_addr_depth_start+10*10/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_12       {koa_ft_map_addr_depth_start+8*8/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_13       {koa_ft_map_addr_depth_start+8*8/kDramAccessBytes};

constexpr int koa_ft_map_addr_depth_end_16       {1+koa_ft_map_addr_depth_start+303*303/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_17       {1+koa_ft_map_addr_depth_start+151*151/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_18       {1+koa_ft_map_addr_depth_start+149*149/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_19       {1+koa_ft_map_addr_depth_start+149*149/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_20       {1+koa_ft_map_addr_depth_start+74*74/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_21       {koa_ft_map_addr_depth_start+72*72/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_22       {koa_ft_map_addr_depth_start+72*72/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_23       {koa_ft_map_addr_depth_start+36*36/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_24       {1+koa_ft_map_addr_depth_start+34*34/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_25       {1+koa_ft_map_addr_depth_start+34*34/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_26       {koa_ft_map_addr_depth_start+32*32/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_27       {koa_ft_map_addr_depth_start+32*32/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_28       {1+koa_ft_map_addr_depth_start+30*30/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_29       {1+koa_ft_map_addr_depth_start+30*30/kDramAccessBytes};

constexpr int koa_ft_map_addr_depth_end_30       {koa_ft_map_addr_depth_start+28*28/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_31       {koa_ft_map_addr_depth_start+28*28/kDramAccessBytes};

constexpr int koa_ft_map_addr_depth_end_32       {1+koa_ft_map_addr_depth_start+23*23/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_38       {1+koa_ft_map_addr_depth_start+23*23/kDramAccessBytes};

constexpr int koa_ft_map_addr_depth_end_33       {1+koa_ft_map_addr_depth_start+21*21/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_34       {1+koa_ft_map_addr_depth_start+19*19/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_35       {1+koa_ft_map_addr_depth_start+17*17/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_36       {1+koa_ft_map_addr_depth_start+17*17/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_37       {1+koa_ft_map_addr_depth_start+17*17/kDramAccessBytes};

constexpr int koa_ft_map_addr_depth_end_39       {1+koa_ft_map_addr_depth_start+21*21/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_40       {1+koa_ft_map_addr_depth_start+19*19/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_41       {1+koa_ft_map_addr_depth_start+17*17/kDramAccessBytes};
constexpr int koa_ft_map_addr_depth_end_42       {1+koa_ft_map_addr_depth_start+17*17/kDramAccessBytes};

// Flexible data_end
constexpr int koa_ft_map_addr_data_end_0        {koa_ft_map_addr_data_start+127*127*2*1};
constexpr int koa_ft_map_addr_data_end_1        {koa_ft_map_addr_data_start+63*63*2*kconv1_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_2        {koa_ft_map_addr_data_start+61*61*2*kconv2_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_3        {koa_ft_map_addr_data_start+61*61*2*kconv2_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_4        {koa_ft_map_addr_data_start+30*30*2*kconv2_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_5        {koa_ft_map_addr_data_start+28*28*2*kconv3_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_6        {koa_ft_map_addr_data_start+28*28*2*kconv3_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_7        {koa_ft_map_addr_data_start+14*14*2*kconv3_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_8        {koa_ft_map_addr_data_start+12*12*2*kconv4_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_9        {koa_ft_map_addr_data_start+12*12*2*kconv4_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_10       {koa_ft_map_addr_data_start+10*10*2*kconv5_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_11       {koa_ft_map_addr_data_start+10*10*2*kconv5_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_12       {koa_ft_map_addr_data_start+8*8*2*kconv6_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_13       {koa_ft_map_addr_data_start+8*8*2*kconv6_PW_kernel_num/kDramAccessBytes};

//z kernel stored at W region
// constexpr int koa_ft_map_addr_data_end_14       {koa_ft_map_addr_data_start+6*6*2*kr_z_k_kernel_num/kDramAccessBytes};
// constexpr int koa_ft_map_addr_data_end_15       {koa_ft_map_addr_data_start+6*6*2*kc_z_k_kernel_num/kDramAccessBytes};
 
constexpr int koa_ft_map_addr_data_end_16       {koa_ft_map_addr_data_start+303*303*2*1};
constexpr int koa_ft_map_addr_data_end_17       {koa_ft_map_addr_data_start+151*151*2*kconv1_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_18       {koa_ft_map_addr_data_start+149*149*2*kconv2_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_19       {koa_ft_map_addr_data_start+149*149*2*kconv2_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_20       {koa_ft_map_addr_data_start+74*74*2*kconv2_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_21       {koa_ft_map_addr_data_start+72*72*2*kconv3_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_22       {koa_ft_map_addr_data_start+72*72*2*kconv3_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_23       {koa_ft_map_addr_data_start+36*36*2*kconv3_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_24       {koa_ft_map_addr_data_start+34*34*2*kconv4_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_25       {koa_ft_map_addr_data_start+34*34*2*kconv4_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_26       {koa_ft_map_addr_data_start+32*32*2*kconv5_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_27       {koa_ft_map_addr_data_start+32*32*2*kconv5_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_28       {koa_ft_map_addr_data_start+30*30*2*kconv6_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_29       {koa_ft_map_addr_data_start+30*30*2*kconv6_PW_kernel_num/kDramAccessBytes};

constexpr int koa_ft_map_addr_data_end_30       {koa_ft_map_addr_data_start+28*28*2*kr_x_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_31       {koa_ft_map_addr_data_start+28*28*2*kc_x_kernel_num/kDramAccessBytes};

constexpr int koa_ft_map_addr_data_end_32       {koa_ft_map_addr_data_start+23*23*2*kc_x_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_38       {koa_ft_map_addr_data_start+23*23*2*kr_x_kernel_num/kDramAccessBytes};

constexpr int koa_ft_map_addr_data_end_33       {koa_ft_map_addr_data_start+21*21*2*kcls_conv1_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_34       {koa_ft_map_addr_data_start+19*19*2*kcls_conv2_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_35       {koa_ft_map_addr_data_start+17*17*2*kcls_conv3_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_36       {koa_ft_map_addr_data_start+17*17*2*kcls_score_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_37       {koa_ft_map_addr_data_start+17*17*2*kctr_score_kernel_num/kDramAccessBytes};

constexpr int koa_ft_map_addr_data_end_39       {koa_ft_map_addr_data_start+21*21*2*kbbox_conv1_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_40       {koa_ft_map_addr_data_start+19*19*2*kbbox_conv2_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_41       {koa_ft_map_addr_data_start+17*17*2*kbbox_conv3_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_addr_data_end_42       {koa_ft_map_addr_data_start+17*17*2*koffset_score_kernel_num/kDramAccessBytes};


// Flexible interval of data
constexpr int koa_ft_map_conv1_interval_of_data        {2*kconv1_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv2_DW_interval_of_data     {2*kconv2_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv2_PW_interval_of_data     {2*kconv2_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv3_DW_interval_of_data     {2*kconv3_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv3_PW_interval_of_data     {2*kconv3_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv4_DW_interval_of_data     {2*kconv4_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv4_PW_interval_of_data     {2*kconv4_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv5_DW_interval_of_data     {2*kconv5_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv5_PW_interval_of_data     {2*kconv5_PW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv6_DW_interval_of_data     {2*kconv6_DW_kernel_num/kDramAccessBytes};
constexpr int koa_ft_map_conv6_PW_interval_of_data     {2*kconv6_PW_kernel_num/kDramAccessBytes};
